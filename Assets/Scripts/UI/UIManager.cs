...
public class UIConst
{
    ...
    public const string DoorTipsPanel = "DoorTipsPanel";
    public const string ScratchTipsPanel = "ScratchTipsPanel";
    public const string MiaoPanel = "MiaoPanel";
...
public class UIManager
{
    ...
    private void InitDicts()
    {
        ...
        pathDict = new Dictionary<string, string>()
        {
            ...
            {UIConst.SettingPanel, "SettingPanel"},
            {UIConst.DoorTipsPanel, "DoorTipsPanel"},
            {UIConst.ScratchTipsPanel, "ScratchTipsPanel"},
            {UIConst.MiaoPanel,"MiaoPanel"},
